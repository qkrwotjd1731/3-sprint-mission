...
export const findProducts = (userId: number, offset: number, limit: number, orderBy?: OrderByType, keyword?: string) =>
...
export const findLikeProducts = (userId: number, offset: number, limit: number, orderBy?: OrderByType, keyword?: string) =>
  prisma.product.findMany({
    skip: offset,
    take: limit,
    orderBy: parseOrderBy(orderBy),
